...
class FractionalExperiment:
    ...
    def __init__(self, n, m):
        ...
        self.x_av_min = (-10 + 25 + -20) / 3
        self.x_av_max = (15 + 45 + -15) / 3
        ...
        self.x_norm = [[1, -1, -1, -1],  # матриця планування ПФЕ при k=3
                       ...
                       [1, 1, -1, -1],
                       [1, 1, 1, 1]]
        self.x_range = [(-10, 15), (25, 45), (-20, -15)]
    ...
    def check(self):
        ...
        """Якщо виконується нерівність t > t_student, то приймається нуль-гіпотеза, тобто вважається, що
        знайдений коефіцієнт  є статистично незначущим і його слід виключити з рівняння регресії.
        Якщо t < t_student то гіпотеза не підтверджується, тобто коефіцієнт значимий і він залишається в
        рівнянні регресії"""
